...
// [REVIEW] SLT corrected register bit placement
...
void slt_reg_assm(void) {
    ...
    */
    ...
    // set Rd
    setBits_num(15, PARAM1.value, 5); // [CHANGE] put Rd in correct place

    // set Rs
    setBits_num(25, PARAM2.value, 5); // [CHANGE] put Rs in correct place

    // set Rt
    setBits_num(20, PARAM3.value, 5); // [CHANGE] put Rt in correct place
