...
void and_reg_assm(void) {
	...
	*/
	...
	// set Rd
	setBits_num(15, PARAM1.value, 5); // [CHANGE] PARAM1 should start at 15 (previously was 25)

	// set Rs
	setBits_num(25, PARAM2.value, 5); // [CHANGE] PARAM2 should start at 25 (previously was 15)
