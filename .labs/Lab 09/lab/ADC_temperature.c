...
void ADC0_Init(void) {
	...
	//ADC0 SS1 Step 3, sample from internal temperature sensor, completion of this step will set RIS, last sample of the sequence
...
// Add Your Code Here
	// ----------------
	/*
	volatile float voltage = <ADC_value> * 3.3 / 4096;
	volatile float temp = (voltage - 0.5) * 100;
	volatile float Fahrenheit = temp ;*/
}
